...
Module GestorPDF
    Public Sub ImprimirTicketComprobante(pTicketComprobante As EL.TicketComprobante)
        ...
        graphics.DrawString("X", New PdfStandardFont(PdfFontFamily.Helvetica, 35), PdfBrushes.Black, New PointF(253.5, -1.5))
        ...
        graphics.DrawString("Agencia ", New PdfStandardFont(PdfFontFamily.Helvetica, 10), PdfBrushes.Black, New PointF(140, 45))
        graphics.DrawString("Dirección ", New PdfStandardFont(PdfFontFamily.Helvetica, 10), PdfBrushes.Black, New PointF(140, 60))
        graphics.DrawString("C.P. ", New PdfStandardFont(PdfFontFamily.Helvetica, 10), PdfBrushes.Black, New PointF(140, 75))
        graphics.DrawString("Prov. ", New PdfStandardFont(PdfFontFamily.Helvetica, 10), PdfBrushes.Black, New PointF(140, 90))

        graphics.DrawString("Nro. Comprobante " + pTicketComprobante.Id.ToString(), New PdfStandardFont(PdfFontFamily.Helvetica, 10), PdfBrushes.Black, New PointF(300, 45))
        graphics.DrawString(pTicketComprobante.Id, New PdfStandardFont(PdfFontFamily.Helvetica, 10), PdfBrushes.Black, New PointF(340, 45))
